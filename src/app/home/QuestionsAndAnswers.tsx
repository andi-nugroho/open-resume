  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        <Link href="https://github.com/andi-nugroho">Andi Nugroho</Link> and designed
        by <Link href="https://www.linkedin.com/in/andiinugroho">Andi Nugroho</Link> as
    ...
    answer: (
      <>
        <p>
          ...
          or{" "}
          <Link href="https://github.com/andi-nugroho/open-resume/issues/new">
            open an issue
          </Link>{" "}
        ...
        <p>
          ...
          by{" "}
          <Link href="https://github.com/andi-nugroho">
